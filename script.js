        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    submitButton.textContent = document.documentElement.dir === 'rtl' ? 'جارٍ الإرسال...' : 'Sending...';
...
(function(){
  ...
  function createFrameAdapter(host, stage, set, label){
    ...
    function load(index){
      ...
      if (supportsBitmap && typeof fetch === 'function') {
        fetch(url, { mode: 'cors' })
          ...
          .catch(function(){
            // CORS/decode fallback: plain <img> (drawImage accepts it).
            var img = new Image();
    ...
    function draw(){
      ...
      try { ctx.drawImage(bmp, 0, 0, canvas.width, canvas.height); } catch (e) {}
    }
  ...
  function initStory(){
    ...
    ensureGsap(function(err){
      ...
      if (resolution.tier === 'model') {
        adapter = createModelAdapter(host, stage, manifest.model, label, function(reason){
      ...
      var applyChapters = setupChapters(host, gsap);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8f0f7f8a-21f5-4fd7-953d-d8bf0e434a1a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8f0f7f8a-21f5-4fd7-953d-d8bf0e434a1a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8f0f7f8a-21f5-4fd7-953d-d8bf0e434a1a';
